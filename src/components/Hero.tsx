...
const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white min-h-[90vh] flex items-center">
      {/* Animated Background */}
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(255,119,198,0.3),transparent_50%)] animate-pulse animation-delay-2000"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_40%_80%,rgba(119,198,255,0.3),transparent_50%)] animate-pulse animation-delay-4000"></div>
      </div>
      ...
      <div className="absolute top-40 right-20 w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full opacity-20 animate-bounce animation-delay-2000"></div>
      <div className="absolute bottom-40 left-20 w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full opacity-20 animate-bounce animation-delay-4000"></div>

      {/* Live Activity Indicator */}
      <div className="absolute top-6 right-6 bg-green-500/90 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-medium flex items-center space-x-2 shadow-lg border border-green-400/30">
      ...
      <div className="container relative mx-auto px-4 py-16">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="mb-8 space-y-4">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto animate-fade-in animation-delay-800">
          ...
          <div className="mb-10 mx-auto max-w-3xl animate-slide-up animation-delay-1000">
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-pink-500 to-violet-500 rounded-2xl blur opacity-20"></div>
              <div className="relative flex items-center bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-2 shadow-2xl">
                <Search className="absolute left-6 h-6 w-6 text-gray-300" />
                <Input
                  type="text"
                  placeholder="Search events, artists, or venues..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="flex-1 pl-14 pr-4 py-6 text-lg border-0 focus:ring-0 bg-transparent text-white placeholder-gray-300"
                />
          ...
          <div className="mb-12 flex flex-wrap justify-center gap-4 animate-fade-in animation-delay-1200">
            {quickFilters.map((filter, index) => (
              <Button
                key={index}
                variant="outline"
                className={`group relative overflow-hidden bg-white/10 backdrop-blur-sm border-white/20 text-white hover:text-white hover:scale-110 transition-all duration-300 shadow-lg hover:shadow-xl`}
              >
          ...
          <div className="mb-12 flex justify-center space-x-8 animate-fade-in animation-delay-1400">
            {categories.map((category, index) => (
              <div key={index} className="text-center group cursor-pointer">
                <div className="w-16 h-16 mx-auto mb-2 bg-white/10 backdrop-blur-sm rounded-2xl flex items-center justify-center group-hover:bg-white/20 transition-all duration-300 group-hover:scale-110">
                  <category.icon className="h-8 w-8 text-gray-300 group-hover:text-white" />
                </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 animate-slide-up animation-delay-1600">
            ...
            <Button 
              size="lg" 
              variant="outline"
              className="px-10 py-6 text-lg border-2 border-white/30 bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 hover:scale-105 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300"
            >
          ...
          {/* Trust Indicators */}
          <div className="mt-16 flex flex-wrap justify-center gap-6 text-sm text-gray-400 animate-fade-in animation-delay-2000">
